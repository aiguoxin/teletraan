...
public interface InterfaceInfoDAO {
    void insert(InterfaceInfoBean interfaceInfoBean) throws Exception;

    List<InterfaceInfoBean> getByNameFlagDate(String name, int flag, String before, String after) throws Exception;

    List<String> getNameListByFlag(int flag) throws Exception;
}
